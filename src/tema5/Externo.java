...
public class Externo
{
	...
	/*
	 * private void Borrar2() { try (RandomAccessFile oba = new
	 * RandomAccessFile(archivo, "rw");) { oba.setLength(0); } catch (IOException e)
	 * { } }
	 */
			...
			try
			{
				while (true)
				{
					for (con = 1; con <= par; con++)
						oba1.write(oba.readInt());
					for (con = 1; con <= par; con++)
						oba2.write(oba.readInt());
				}
			}
			catch (EOFException e)
			{
